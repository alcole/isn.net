...
namespace IsnLibrary
{
    ...
    {
        public const Int16 ISBN13_LENGTH = 13;
        public const Int16 ISBN10_LENGTH = 10;
        public const Int16 ISSN_LENGTH = 8;
        public static char generateCheck(String isn)
        {
            if (!(isn.Length == ISBN13_LENGTH
                ...
                || isn.Length == ISSN_LENGTH - 1)) throw new ArgumentException();
